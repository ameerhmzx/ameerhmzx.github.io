...
export default function TypicalLayout({child}: PropsWithoutRef<{child: Function}>) {
  ...
  return (
    <>
      <div
        ref={header}
        className={'w-full z-30 fixed top-0 bg-white dark:bg-black bg-opacity-60 dark:bg-opacity-40 backdrop-filter backdrop-blur-md border-b border-gray-200 dark:border-gray-800'}>
